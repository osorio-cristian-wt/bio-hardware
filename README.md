...
|---|---|---|
| 📚 Investigación de fuentes primarias | **Completa** | 16 fuentes en `sources/` |
...
| 🖥️ Guía de presentación de 15 min (timing + contenido por diapositiva) | **Completa** | `entregables/02` |
| 🎨 Prompt para Claude Design (genera el canvas visual de la presentación) | **Completo** | `entregables/03` |
...
│
├── sources/                 ← 16 fuentes documentadas, 1 archivo c/u
...
└── entregables/
    ...
    ├── 02_guia_presentacion_15min.md  ← timing + contenido de una charla de 15 min
    └── 03_prompt_claude_design.md     ← prompt para generar el diseño visual de esa charla
```
...
- **Si querés el análisis crítico de un ángulo específico** → `analisis/01` (¿es cierto el argumento de eficiencia energética?) o `analisis/02` (¿cuáles son las posturas éticas reales, más allá de "a favor/en contra"?).
